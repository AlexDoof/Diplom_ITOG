...
Процедура ВКМ_ЗаполнитьНаСервере(Объект) Экспорт
	//Доработка
	ВидДоговораОбъекта = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ВидДоговора");
	АбонентскаяПлатаДоговораОбъекта = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ВКМ_АбонентскаяПлата");
	ДатаНачалаДействияДоговора = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ВКМ_НачалоДействияДоговора");
