...
Процедура ВКМ_ЗаполнитьНаСервере(Объект) Экспорт
	...
	ДатаНачалаДействияДоговора = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Договор, "ВКМ_НачалоДействияДоговора");
	ДатаОкончанияДействияДоговора = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Договор,
		"ВКМ_КонецДействияДоговора");
		
	Если ВидДоговораОбъекта = Перечисления.ВидыДоговоровКонтрагентов.АбонентскоеОбслуживание Тогда
		Если Объект.Дата < ДатаНачалаДействияДоговора Или Объект.Дата > ДатаОкончанияДействияДоговора Тогда
